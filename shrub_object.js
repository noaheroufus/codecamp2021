function ShrubObject(webgl, x, y, width, height) {
    this.webgl = webgl;
    ...
    let version = Math.floor(Math.random()*8);
    let options = [SHRUB_1, SHRUB_2, SHRUB_3, SHRUB_4, SHRUB_5, SHRUB_6, SHRUB_7, SHRUB_8];
    this.texture = TEXTURES[options[version]];
}

ShrubObject.prototype.update = function(time, delta) {
}

ShrubObject.prototype.render = function() {
