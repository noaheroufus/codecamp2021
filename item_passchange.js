function ItemPasschange(x, y) {
    ...
    this.texture = TEXTURES[ITEM_PASSCHANGE];
}

ItemPasschange.prototype.update = function(time, delta) {
    this.translate_y = ( Math.abs(Math.sin(this.counter)) * 20) * -1;
    this.counter += this.increment;
    if(this.counter > Math.PI*2) this.counter = 0;
}

ItemPasschange.prototype.render = function() {
